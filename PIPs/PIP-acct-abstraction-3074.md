...
|-------------------|---------------------------------|----------------------|-------------------------------|------------|--------|------------------------------------------|-----------------------|
| To be assigned by PIP Editors | EIP-3074-style Account Abstraction | Implementation of the `AUTH` and `AUTHCALL` EVM opcodes  | Will Schwab (@wschwab) | https://forum.polygon.technology/t/pip-add-eip-3074-style-account-abstraction/12959/1  | Draft  | Core | (yyyy-mm-dd) format |
